 ...
 */
package mg.itu.tpCustomerAntenainaRANDRIANANTOANDRO.entities;
...
public class Customer implements Serializable {
    ...
    public String toString() {
        return "mg.itu.tpCustomerAntenainaRANDRIANANTOANDRO.entities.Customer[ customerId=" + customerId + " ]";
    }
